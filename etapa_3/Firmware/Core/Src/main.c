...
int main(void)
{
  ...
  /* add queues, ... */
  current_queue = osMessageQueueNew(CURRENT_QUEUE_LENGTH, sizeof(uint32_t[DMA_BUFF_LENGTH]), NULL); //TODO: set data size
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, CS3_Pin|CS2_Pin, GPIO_PIN_RESET);
