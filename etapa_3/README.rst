...
serial, e o terminal do computador foi configurado para receber as mensagens. Devido à um problema de comunicação,
não foi possível realizar a leitura da rede CAN.
